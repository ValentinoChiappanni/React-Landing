      ...
      <section className="row">
        ...
        <div className="col-md-6">
          ...
          <p>
            ...
            remota. Trabaje, asista a reuniones, organice eventos, brinde clases
            y conecte a toda su fuerza de trabajo remota, todo en espacios
            virtuales que les permiten a las personas sentir que están
            exactamente donde pertenecen.
          </p>
        </div>
      </section>
      <section className="row">
